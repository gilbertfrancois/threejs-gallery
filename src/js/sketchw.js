...
export class Sketch {
    ...
    setupListeners() {
        ...
        this.on_mouse_down = this.onMouseDown.bind(this);
        this.on_mouse_move = this.onMouseMove.bind(this);
        window.addEventListener("resize", this.on_resize_bound);
        document.addEventListener("wheel", this.on_wheel_bound, false);
    ...
    setupObjects() {
        this.geometry = new THREE.PlaneGeometry(this.image_w, this.image_h, 1, 1);
        ...
        this.shuffleArray(this.textures);
    ...
    render() {
        ...
        if (this.showing_grid) {
            this.scroll += (this.scrollTarget - this.scroll) * 0.2;
    ...
    destroy() {
        ...
        document.removeEventListener("mousedown", this.on_mouse_down, false);
        document.removeEventListener("mousemove", this.on_mouse_move, false);
        this.destroyed = true;
    }
    ...
    onWheel(event) {
        ...
        this.scrollTarget = event.wheelDelta * 0.1;
    }
    ...
    onMouseMove(event) {
        ...
        this.scrollTarget = -this.mouse.x;
